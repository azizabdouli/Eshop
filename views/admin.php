...
<body>
  ...
  <div class="container" style="margin:40px">
    ...
    <ul class="nav nav-tabs">
      ...
      <li><a class="tab" href="stats.php">Statistics</a></li>
    </ul>
    ...
    while($table = $showtables->fetch_array()) { // go through each row that was returned in $result
        ...
        //bootstrap search form with action

        if($table[0]=="customers" ){
          echo "<form class='form-inline' action='customerssearch.php?action=search' method='post'>";
        ...
        //bootstrap sort ascending and descending with table name dropdown menu
        if($table[0]=="customers" ){
          echo "<form class='form-inline' action='sortcustomers.php?action=sort' method='post'>";
          echo "<div class='form-group'>";
          ...
          echo "<option value='address'>Adress</option>"; 
          echo "</select>";
          echo "</div>";
          echo "<div class='form-group'>";
        ...
        if($table[0]=="products" ){
          echo "<form class='form-inline' action='productssearch.php?action=search' method='post'>";
          echo "<div class='form-group'>";
          echo "<input type='text' class='form-control' name='search' placeholder='Search'>";
          echo "</div>";
          echo "<button type='submit' class='btn btn-default'>Search</button>";
        ...
        if($table[0]=="products"){
          echo "<form class='form-inline' action='sortproducts.php?action=sort' method='post'>";
          echo "<div class='form-group'>";
          echo "<select class='form-control' name='table'>";
          echo "<option value='id'>Id</option>";
