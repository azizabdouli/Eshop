...
<body>
  ...
  <div class="container" style="margin:40px">
    ...
    <form class="form-horizontal" method="post" action="../controllers/addproduct.php?action=addToProducts" enctype="multipart/form-data">
      ...
      <div class="form-group">
        <label class="control-label col-sm-2" for="price">Product image:</label>
        <div class="col-sm-10">
