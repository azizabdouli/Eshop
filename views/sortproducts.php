  ...
  if(isset($_REQUEST['action']) && !empty($_REQUEST['action'])){
      if($_REQUEST['action'] == 'sort'){
          //extract($_POST);
            ...
            $query = "SELECT * FROM products ORDER BY $table $sort";
            ...
            if($result->num_rows > 0){
              ...
              echo '<tbody>';
                while($row = $result->fetch_assoc()){
                    ...
                    echo '<td><a href="editproductadmin.php?id='.$row['id'].'"><span class="glyphicon glyphicon-edit"></span></a> <a href="../controllers/deleteController.php?id='.$row['id'].'"><span class="glyphicon glyphicon-trash"></span></a></td>';
                    echo '</tr>';
                }
                echo '</table>';
            }else{
